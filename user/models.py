...
class User(AbstractUser):
    ...
    phone_sms=models.BooleanField(default=False,verbose_name="دریافت sms")
    email_notif=models.BooleanField(default=False,verbose_name="دریافت ایمیل")
...
class account_detail(models.Model):
    ...
    rank=models.ForeignKey(Rank,on_delete=models.CASCADE,related_name="acc_detail")
