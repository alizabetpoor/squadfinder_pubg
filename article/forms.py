...
class searchbar(ModelForm):
    def __init__(self, *args,**kwargs):
        ...
        # self.fields["server"].widget.option_template_name=BASE_DIR / "templates/article/forms/select_option.html"
        # self.fields["server"].widget.template_name=BASE_DIR / "templates/article/forms/select.html"
